 ...
 */
#ifndef HSAQMAODV_RQUEUE_H
#define HSAQMAODV_RQUEUE_H
...
/**
 * \ingroup saqmaodv
 * \brief SAQMAODV route request queue
 *
 * Since SAQMAODV is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
  public:
