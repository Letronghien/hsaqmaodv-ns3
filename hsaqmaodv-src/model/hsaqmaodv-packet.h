 ...
 */
#ifndef SAQMAODVPACKET_H
#define SAQMAODVPACKET_H
...
enum MessageType
{
    SAQMAODVTYPE_RREQ = 1,    //!< SAQMAODVTYPE_RREQ
    SAQMAODVTYPE_RREP = 2,    //!< SAQMAODVTYPE_RREP
    SAQMAODVTYPE_RERR = 3,    //!< SAQMAODVTYPE_RERR
    SAQMAODVTYPE_RREP_ACK = 4 //!< SAQMAODVTYPE_RREP_ACK
};

/**
 * \ingroup saqmaodv
 * \brief SAQMAODV types
 */
class TypeHeader : public Header
{
  public:
    /**
     * constructor
     * \param t the SAQMAODV RREQ type
     */
    TypeHeader(MessageType t = SAQMAODVTYPE_RREQ);
