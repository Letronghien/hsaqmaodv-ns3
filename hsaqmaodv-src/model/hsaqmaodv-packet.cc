...
{
    static TypeId tid = TypeId("ns3::hsaqmaodv::TypeHeader")
                            .SetParent<Header>()
...
{
    static TypeId tid = TypeId("ns3::hsaqmaodv::RreqHeader")
                            .SetParent<Header>()
                            .SetGroupName("Saqmaodv")
...
{
    static TypeId tid = TypeId("ns3::hsaqmaodv::RrepHeader")
                            .SetParent<Header>()
                            .SetGroupName("Saqmaodv")
...
{
    static TypeId tid = TypeId("ns3::hsaqmaodv::RrepAckHeader")
                            .SetParent<Header>()
                            .SetGroupName("Saqmaodv")
...
{
    static TypeId tid = TypeId("ns3::hsaqmaodv::RerrHeader")
                            .SetParent<Header>()
                            .SetGroupName("Saqmaodv")
