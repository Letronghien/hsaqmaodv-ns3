 ...
 */
#ifndef SAQMAODVROUTINGPROTOCOL_H
#define SAQMAODVROUTINGPROTOCOL_H

#include "saqmaodv-dpd.h"
#include "saqmaodv-neighbor.h"
#include "saqmaodv-packet.h"
#include "saqmaodv-rqueue.h"
 ...
 * \ingroup saqmaodv
 *
 * \brief SAQMAODV routing protocol
 */
class RoutingProtocol : public Ipv4RoutingProtocol
{
  public:
    ...
    static const uint32_t SAQMAODV_PORT;
  ...
  void SetTVIHigh(double v){m_qtable.SetTVIHigh(v);}
  void SetTVILow(double v){m_qtable.SetTVILow(v);}
  void SetSigTheta(double v){m_qtable.SetSigTheta(v);}
  void SetSigSigma(double v){m_qtable.SetSigSigma(v);}
    void Start();
    /**
     ...
     */
    void RecvSaqmaodv(Ptr<Socket> socket);
    /**
     * Receive RREQ
     * \param p packet
...
#endif /* SAQMAODVROUTINGPROTOCOL_H */
